	...
	export default {
		...
		mounted() {
            ...
            var renderCharts = () => {
                ...
                gradeConfig.margins = {top: 5, left: 20, right: 30, bottom: 50}
...
/*                 var percentGroup = this.ndx.groupAll().reduce(stemAdd,stemRemove,stemInitial)
                ...
                percentND.group(percentGroup)
                    ...
                    .valueAccessor(function(d) {return d.allPercent})
                    .html({
                        one:"<span style=\"color:steelblue; font-size: 20px;\">%number%</span>"
                    })
 */
                ...
                .on('click', ()=>{
                    ...
                    FileSaver.saveAs(blob, 'PERSTAT Officer_All_Degrees' + ' ' + store.state.asDate + myFilters + ' .csv');
                });
